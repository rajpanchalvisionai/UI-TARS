...
def _mp_fn(index):
    ...
    for step in range(max_steps):
        ...
        inputs = {
            ...
            'attention_mask': tensors_to_broadcast[2].to(device) # Use the attention mask
        }
